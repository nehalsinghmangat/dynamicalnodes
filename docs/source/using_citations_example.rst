...
Our implementation of the Kalman filter can be found in ``dynamicalnodes.utilities.estimators.kf``.
The implementation follows the formulation presented in :cite:`kalman1960new`.

See Also
========

For a complete list of papers and algorithms, visit the main documentation page,
