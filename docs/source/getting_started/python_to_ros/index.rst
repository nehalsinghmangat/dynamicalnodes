...
The "Dynamical Systems as ROS Nodes" section show how the dynamical system block diagrams we created in the "Theory to Python" can be implemented as ROS nodes.

The "ROS Tips and Tricks" section serves as a reference for useful ROS commands. 
...
..  toctree::
    ...
    installation
    dynamical_systems_as_ros_nodes
    modules
    ros_tips_and_tricks
    troubleshooting
